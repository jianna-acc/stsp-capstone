...
class FakeAdminService:
    ...
    def __init__(
        ...
        self.received_stale_after_minutes: (
            int | None
        ) = None

        self.received_max_attempts: (
            int | None
        ) = None
...
def test_worker_recovers_stale_jobs() -> None:
    ...
    assert (
        admin.recovery_count
        == 1
    )

    assert (
        admin.received_stale_after_minutes
        == 30
    )

    assert (
        admin.received_max_attempts
        == 3
    )
...
def test_worker_rejects_invalid_recovery_settings() -> None:
    ...
    try:
        ...
        raise AssertionError(
            "Expected invalid recovery interval "
            "to raise ValueError.",
        )
    ...
    try:
        ...
        raise AssertionError(
            "Expected invalid stale duration "
            "to raise ValueError.",
        )
    ...
    try:
        ...
        raise AssertionError(
            "Expected invalid maximum attempts "
            "to raise ValueError.",
        )