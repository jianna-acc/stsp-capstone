// File: /frontend/features/quizzes/server/options.ts
// Purpose: Loads the authenticated student's subjects and
// ready study files for Quiz generation options.
...
const FILTER_LOAD_ERROR =
  "Your subjects and ready study materials could not be loaded. Quiz generation is temporarily unavailable.";
